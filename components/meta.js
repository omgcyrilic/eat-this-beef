...
export default function Meta({
  ...
  return (
    <Head>
      ...
      <meta name="twitter:image" content={image ? 'https://eatthisbeef.com/' : 'https://eatthisbeef.com/'} />
      ...
      <meta property="og:image" content={image ? 'https://eatthisbeef.com/' : 'https://eatthisbeef.com/'} />
      <meta property="og:url" content="http://eatthisbeef.com/" />
      ...
      <link rel="shortcut icon" href="http://images.eatthisbeef.com/favicon.png" type="image/x-icon" />
    </Head>
  )
}
